...
from semantic_tensor_memory.memory.store import append
import re
...
def initialize_session_state():
    ...
    if 'memory' not in st.session_state:
        from semantic_tensor_memory.memory.store import load
...
def robust_pca_pipeline(memory_slice, meta_slice, n_components=2, return_scaler=False, 
    ...
    """
    from semantic_tensor_memory.analytics.tensor_batching import (
        pad_and_stack,
        flatten_with_mask,
    )
