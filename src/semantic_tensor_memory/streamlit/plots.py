...
def plot_heatmap_plotly(tensors):
    ...
    from semantic_tensor_memory.analytics.tensor_batching import pad_and_stack, masked_session_means
...
def create_pca_visualization(results, meta_slice, is_3d=False):
    ...
    if is_3d:
        ...
        try:
            from semantic_tensor_memory.streamlit.utils import generate_dynamic_axis_labels
...
def create_pca_timeline_animation(memory, meta, animation_speed=800, is_3d=False):
    ...
    from semantic_tensor_memory.streamlit.utils import robust_pca_pipeline
...
def create_liminal_tunnel_visualization(memory, meta, tunnel_segments=25, tunnel_radius_base=0.15):
    ...
    try:
        from semantic_tensor_memory.streamlit.utils import robust_pca_pipeline
        from semantic_tensor_memory.visualization.viz.pca_plot import prepare_for_pca
        from sklearn.manifold import TSNE
