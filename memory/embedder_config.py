...
def get_embedder():
    ...
    if CURRENT_MODE == EmbeddingMode.BERT_AVERAGE:
        from memory.embedder import embed_sentence, get_token_count
        ...
        from memory.embedder import embed_sentence, get_token_count  # Assumes CLS version
...
def get_hybrid_embedder():
    ...
    from memory.embedder_hybrid import embed_sentence_with_summary, get_token_count
